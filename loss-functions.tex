...
\begin{align*}
	\sum_{i, j = 1}^n &\mathmat{\eta}_{ij} \left\lVert \mathvec{L} \left( \mathvec{x}_i - \mathvec{x}_j \right) \right\rVert^2 + \\
	+ c \sum_{i, j, l = 1}^n  &\mathmat{\eta}_{ij} \left( 1 - \mathmat{y}_{il} \right) \\
	&\left\{ \left\lVert \mathvec{L} \left( \mathvec{x}_i - \mathvec{x}_l \right) \right\rVert^2 - \left\lVert \mathvec{L} \left( \mathvec{x}_i - \mathvec{x}_j \right) \right\rVert^2 \right\}_+
\end{align*}
